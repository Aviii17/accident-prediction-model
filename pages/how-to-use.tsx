...
const HowToUse = () => {
    ...
    return (
      ...
      <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSd3j1rU31vVMid4ma_7BIvXnkbE_OrHz7KykpeqLht8HOShxA/viewform?embedded=true" width="640" height="947" frameborder="0" marginHeight="0" marginWidth="0">Loading…</iframe>
            </div>
        </div>
    )
}
