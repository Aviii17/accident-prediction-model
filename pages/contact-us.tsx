...
const ContactUs = () => {
  return (
    <div>
      ...
      <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSd3j1rU31vVMid4ma_7BIvXnkbE_OrHz7KykpeqLht8HOShxA/viewform?embedded=true" width="640" height="1500" >Loading…</iframe>
    </div>
  )
}
